 ...
 * @returns {{_client: *, deleteItem, evalScript, getItem, setItem, keys, maybeAddToQueryCache, pluckFromQueryCache, setOrDeleteCacheBucket}}
 * @constructor
 */
const Cache = redisClient => ({
  _client                : redisClient,
  deleteItem             : require('./methods/deleteItem')(redisClient),
  evalScript             : require('./methods/evalScript')(redisClient),
